...
namespace HREngine.Bots
{
    ...
    {
        private static string mainPath = @"C:\yuzu\HearthStudy\Routines\DefaultRoutine\Silverfish\"; // 确保此路径正确
        private static string testPath = @"Test\Data\1\"; // 需要测试的文件夹 
        ...
        public void Test(string data)
        {
            ...
            {
                ai = Ai.Instance;
                ai.botBase = new Behavior丨狂野丨快攻暗牧();  //根据卡组选择合适的策略
